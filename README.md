...
Better NeoForge Console is configurable through the `better_neoforge_console.conf` file generated in the config folder. Requires NeoForge for Minecraft 1.21.1.
