...
dependencies {
  ...
  addToAdditionalRuntimeClasspath("net.kyori:adventure-text-serializer-gson:$adventureVersion")
  addToAdditionalRuntimeClasspath("net.kyori:adventure-text-serializer-ansi:$adventureVersion")
  ...
  jarJar("net.kyori:adventure-text-serializer-gson:$adventureVersion")
  jarJar("net.kyori:adventure-text-serializer-json:$adventureVersion")
